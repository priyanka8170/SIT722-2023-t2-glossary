...
const glossary = [
  ...
  },
  {
    ...
    definition: 'The phrase "container infrastructure" refers to the underpinning technology and platform used to manage and set up containers, which are compact, independent, and executable software packages that contain all of the necessary running parts, such as the code, runtime, libraries, and system tools.',
    references: 'https://www.docker.com/resources/what-container/'
  },
  {
    id: 42,
    term: 'Docker Volume',
    definition: 'An object that can be shared between containers or between a container and the host system is referred to as a "volume" in the Docker software. Data generated by Docker containers can be managed and stored on volumes, which can also be used to exchange data between containers. They give containers a way to store and access data without regard to the lifecycle of the container.',
    references: 'https://docs.docker.com/storage/volumes/'
  },
  {
    id: 43,
    term: 'Docker Bridge Network',
    definition: 'A Docker bridge network is a personal internal network that enables communication between Docker containers via a bridge interface while offering separation from the host network.',
    references: '"Network virtualization by using software-defined networking controller based Docker," 2016 IEEE Information Technology, Networking, Electronic and Automation Control Conference, Chongqing, China, pp. 1112-1115, doi: 10.1109/ITNEC.2016.7560537. L. Xingtao, G. Yantao, W. Wei, Z. Sanyou, and L. Jiliang.'
  },
  {
    id: 44,
    term: 'Docker Overlay Network',
    definition: 'Using a software-defined network called a Docker overlay network, containers running on several Docker hosts can securely and effectively communicate with one another, creating a virtual network that spans various physical or virtual machines. ',
    references: '"Network virtualization by using software-defined networking controller based Docker," 2016 IEEE Information Technology, Networking, Electronic and Automation Control Conference, Chongqing, China, pp. 1112-1115, doi: 10.1109/ITNEC.2016.7560537. L. Xingtao, G. Yantao, W. Wei, Z. Sanyou, and L. Jiliang.'
  },
  {
    id: 45,
    term: 'Docker macvlan attack',
    definition: 'A specific kind of Docker network called a Macvlan enables containers to have their own distinct MAC addresses and show up as separate devices on the physical network, allowing for direct contact with resources on other networks.',
    references: '"Network virtualization by using software-defined networking controller based Docker," 2016 IEEE Information Technology, Networking, Electronic and Automation Control Conference, Chongqing, China, pp. 1112-1115, doi: 10.1109/ITNEC.2016.7560537. L. Xingtao, G. Yantao, W. Wei, Z. Sanyou, and L. Jiliang.'
  },
  {
    id: 46,
    term: 'Container Communication',
    definition: 'The exchange of data and messages among containers working in a containerized environment is referred to as "container communication". As a result, microservices and applications can collaborate easily to carry out activities including data sharing, action planning, and system functionality.',
    references: 'X. Deng, Y. Huang, D. Yang, C. Zhang, Y. Li and L. Xie, Research on real-time interaction method of high-speed bus communication based on Docker container,.'
  },
  {
    id: 47,
    term: 'Docker Direct Comunication HTTP',
    definition: 'The ability of a containerized application to communicate with external systems or services over the HTTP protocol without the requirement for intermediary proxies or additional networking setups is referred to as "direct communication via HTTP in a container."',
    references: 'J. Shah and D. Dubaria, "Building Modern Clouds: Using Docker, Kubernetes & Google Cloud Platform, 2019 IEEE 9th Annual Computing and Communication Workshop and Conference (CCWC).'
  },
  {
    id: 48,
    term: 'Docker Indirect communication ',
    definition: 'Instead of using shared volumes, network ports, or API gateways for direct inter-container communication, indirect communication in a Docker container refers to a technique where containers exchange data or interact with external resources through these intermediaries.',
    references: 'J. Shah and D. Dubaria, "Building Modern Clouds: Using Docker, Kubernetes & Google Cloud Platform, 2019 IEEE 9th Annual Computing and Communication Workshop and Conference (CCWC).'
  },
  {
    id: 49,
    term: 'Bitbucket Pipelines',
    definition: 'BitBucket is a cloud-based service that helps developers store and manage their code, as well as track and control the changes to their code. BitBucket provides a cloud-based Git repository hosting service. Its interface is user-friendly enough so even novice coders can take advantage of Git. ',
    references: 'https://www.geeksforgeeks.org/introduction-to-bitbucket/'
  },
  {
    id: 50,
    term: 'Kubernetes',
    definition: 'An open-source framework for container orchestration called Kubernetes automates the installation, expansion, and administration of containerized applications across server clusters. It offers a very flexible and effective method for controlling container workloads in a distributed setting.',
    references: 'J. Shah and D. Dubaria, "Building Modern Clouds: Using Docker, Kubernetes & Google Cloud Platform, 2019 IEEE 9th Annual Computing and Communication Workshop and Conference (CCWC)'
  }, 
